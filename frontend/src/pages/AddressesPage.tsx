...
export default function AddressesPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
            ...
            >
              <div className="flex justify-between items-start mb-2">
                <div>
                  ...
                  {address.phone && <p className="text-gray-700">📱 {address.phone}</p>}
                  {address.isDefault && (
      ...
      {deleteId && (
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50" onClick={() => setDeleteId(null)}>
          <div className="bg-white rounded-lg p-6 max-w-sm shadow-xl" onClick={(e) => e.stopPropagation()}>
            <h2 className="text-xl font-bold mb-4 text-red-600">Delete Address?</h2>
