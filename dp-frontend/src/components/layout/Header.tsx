...
export default function Header() {
  ...
  return (
    <header className="bg-white shadow-md border-b-4 border-brand-600 sticky top-0 z-50">
      <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
        {/* Logo */}
        <div className="flex items-center gap-2 cursor-pointer" onClick={() => navigate('/')}>
          <div className="bg-brand-600 text-white px-3 py-2 rounded-lg font-bold text-lg">
            🚚
          </div>
          <div>
            <h1 className="text-xl font-bold text-brand-700">QuickGrocery</h1>
            <p className="text-xs text-brand-600">Delivery Partner</p>
          </div>
        </div>
